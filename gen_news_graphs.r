...
latest_database <- as.Date("2020-10-06")
target_variable <- "x_servs_world" # x_world, x_servs_world, x_vol_world2
...
database_dates <- c("2020-08-07","2020-08-16","2020-08-25", "2020-09-01", "2020-09-08", "2020-09-15", "2020-09-22", "2020-09-29", "2020-10-06")
which_months <- c((seq(target_period, length=4, by="-1 months") %>% sort), (seq(target_period, length=5, by="1 months") %>% sort)) %>% unique
which_months <- which_months[which_months < min(database_dates)] # only do artificial lags for when before started getting data weekly
